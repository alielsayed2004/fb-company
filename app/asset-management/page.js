  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-fb-teal text-fb-white py-20 md:py-24 px-4 sm:px-6 relative overflow-hidden flex flex-col justify-center min-h-[80vh] md:min-h-screen">
        ...
        <div className="max-w-5xl mx-auto z-10 relative space-y-5 w-full text-start">
          <motion.span 
          ...
          <motion.h1 
            ...
            className="text-fb-bg-light max-w-3xl leading-snug font-extrabold text-2xl sm:text-3xl lg:text-[2.5rem]"
          >
            {t('asset.title')}
          </motion.h1>
          <motion.p 
      ...
      <section className="py-20 bg-fb-bg-light border-b border-fb-bg-light">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <h2 className="text-fb-teal font-extrabold tracking-tight text-3xl md:text-4xl">{t('asset.processTitle')}</h2>
          </div>
          ...
          >
            {steps.map((step, idx) => (
              <motion.div 
                ...
                className="relative bg-fb-bg-light/90 border border-fb-teal/15 rounded-3xl p-6 sm:p-7 space-y-4 shadow-[0_8px_30px_rgba(0,59,60,0.05)] hover:shadow-[0_15px_35px_rgba(83,179,121,0.15)] hover:border-fb-green hover:-translate-y-1.5 transition-all duration-300 overflow-hidden flex flex-col justify-between group"
              >
                ...
                <div className="space-y-4 relative z-10">
                  <div className="flex justify-between items-center">
                    <span className="text-fb-green font-mono font-extrabold text-3xl block">{step.num}</span>
                    <div className="p-2.5 rounded-xl bg-fb-teal/5 text-fb-green border border-fb-teal/10 group-hover:bg-fb-green/10 group-hover:border-fb-green/30 transition-colors">
                      {step.icon}
                    </div>
                  </div>
                  <h4 className="text-fb-teal font-extrabold text-lg">{step.title}</h4>
      ...
      <section className="py-20 bg-fb-bg-light border-b border-fb-teal/5">
        ...
        >
          <div className="text-center space-y-4">
            ...
            <h2 className="text-fb-teal font-extrabold tracking-tight text-3xl md:text-4xl">{t('asset.specialitiesTitle')}</h2>
          </div>
          ...
          >
            {services.map((service, idx) => (
              ...
              >
                ...
                <div className="space-y-4 relative z-10">
                  <div className="p-3.5 bg-fb-teal/5 inline-block rounded-2xl border border-fb-teal/10 text-fb-green group-hover:bg-fb-green/10 group-hover:border-fb-green/30 transition-colors">
                    {service.icon}
                  </div>
      ...
      <section className="py-20 bg-fb-bg-light border-b border-fb-bg-light">
        ...
        >
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <h3 className="text-fb-teal font-bold text-2xl">{t('asset.philosophyTitle')}</h3>
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <h3 className="text-fb-teal font-bold text-2xl">{t('asset.securityTitle')}</h3>
            <p className="text-slate-700 text-sm md:text-base leading-relaxed">
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <h3 className="text-fb-teal font-bold text-2xl">{t('asset.performanceTitle')}</h3>
            <p className="text-slate-700 text-sm md:text-base leading-relaxed">
